...
function readURL(input) {
    ...
    if (input.files && input.files[0]) {
    	...
    	reader.onload = function(e) {
    		...
    		document.getElementById('form-viewer').innerHTML+='<form id="form-info-1" action="https://script.google.com/macros/s/AKfycbxFQcPIQYXI3wSwo14dRTJ4lyF_Ci5xWxk0HYOxdoY5n2d291I/exec" data-type="JSON" method="POST"><br><br>name <input class="input-field" type="text" name="full-name" value="" placeholder="full name" required><br>email <input class="input-field" type="text" name="email" value="" required><br><div class="additional-notes">notes<textarea class="notes" type="text" name="additional-notes" value="" placeholder="e.g. recolor to blue"></textarea></div><input class="submit-button" type="submit" value="START"><input type="hidden" name="searched-item" value="' + fileName + '"><input type="hidden" name="url-searched-item" value="upload a file"><br><br><br></form>';
    		loaded();
    	};
